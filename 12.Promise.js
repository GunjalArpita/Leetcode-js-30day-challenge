...
// promise2 = new Promise(resolve => setTimeout(() => resolve(5), 60))  //Output: 7
// Explanation: The two input promises resolve with the values of 2 and 5 respectively. The returned promise should resolve 
// with a value of 2 + 5 = 7. The time the returned promise resolves is not judged for this problem.
